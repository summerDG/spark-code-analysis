...
10. EliminateOuterJoin，这条规则是尽量将fullOuterJoin转化为left/right outer join，甚至是inner join，**null-unsupplying谓词表示，如果有null作为输入则返回false或null，也就是说不支持经过该谓词过滤的结果中还包含null**，包含5种情况：
